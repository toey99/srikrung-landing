...
class SriKrungChatbot:
    ...
    def _load_knowledge_base(self) -> Dict:
        ...
        return {
            ...
            "member_package": {
                "price": "200 บาท",
                "type": "สมัครครั้งเดียว ตลอดชีพ ไม่ต้องต่ออายุ",
                "benefits": [
                    "ได้รับส่วนลดในการซื้อประกันรถยนต์ (พ.ร.บ. และประกันชั้น 1, 2+, 3+, 2, 3) ราคาทุนทันที",
                    "แถมฟรีประกันอุบัติเหตุ (PA) วงเงิน 100,000 บาท",
                    "สิทธิซื้อประกันราคาสมาชิกตลอดชีวิต"
                ],
                "requirements": "อายุ 20-60 ปี ใช้บัตรประชาชน เบอร์โทรศัพท์ และบัญชีธนาคาร (กสิกรไทยดีที่สุด)",
                "registration_link": "https://member.724.co.th/register_member/u/AM00441133"
            },
            "mgm_system": {
                "name": "Member Get Member (MGM)",
                "highlights": [
                    "ไม่ต้องมีหน้าร้าน",
                    "ไม่ต้องสต็อกสินค้า",
                ...
                "levels": {
                    "level_6": {
                        "name": "Member (ระดับ 6)",
                        "condition": "สมาชิกใหม่ ยังไม่มีบัตรนายหน้า",
                        "benefits": [
                            "ซื้อใช้เองได้ราคาทุน",
                            "แนะนำบอกต่อได้ค่าแนะนำ 1% จากยอดสุทธิกรมธรรม์"
                        ]
                    },
                    "level_5": {
                        "name": "Supervisor (ระดับ 5)",
                        "condition": "สอบผ่านและมีบัตรนายหน้าประกันวินาศภัย",
                        "benefits": [
                            "ค่าตำแหน่ง 3%",
                            "ค่าแนะนำ 1% (รวมเป็น 4%)",
                            "สร้างสายงานรับค่าบริหารทีมได้",
                            "สร้าง Passive Income อย่างมั่นคง"
                        ]
                    }
                }
            },
            "products": {
                ...
                "insurance_types": [
                    ...
                    {
                        "type": "ชั้น 3+",
                        "coverage": "คุ้มครองชน ไฟไหม้ น้ำท่วม แบบประหยัด",
                        "target": "รถอายุมาก ต้องการความคุ้มครองแบบประหยัด"
                    },
                    {
                        "type": "ชั้น 3",
                        "coverage": "เฉพาะชนแล้วหนี หรือถูกชนโดยไม่มีคู่กรณี (กปช.)",
                        "target": "รถอายุมาก ประหยัดสุด คุ้มครองตาม กม."
                    }
                ],
                "hiace_promo": {
                    "models": ["Toyota HiAce ECO MT", "Toyota HiAce GL AT"],
                    "type": "ประกัน 2+/3+ แบบเหมาจ่าย (Flat Rate)",
                    "price_range": "5,XXX - 7,XXX บาท/ปี",
                    "coverage": "คุ้มครองรถชน น้ำท่วม ไฟไหม้ สูญหาย",
                    "note": "ราคาขึ้นอยู่กับบริษัทประกันและขนาดเครื่องยนต์ ต้องขอใบเสนอราคาเฉพาะ"
                }
            },
            "conversation_flows": {
                "flow_1_retail": {
                    "trigger": ["1", "เช็คเบี้ย", "ซื้อใช้เอง"],
                    "action": "ขอเอกสารเพื่อทำใบเสนอราคา",
                    "documents_required": [
                        "สำเนารถ",
                        "กรมธรรม์เดิม (ถ้ามี)",
                        "ประเภทประกันที่สนใจ"
                    ],
                    "catchphrase": "ส่งรายการจดทะเบียนรถมาให้หนูเช็คราคาพิเศษได้เลยค่ะ",
                    "upsell": "แนะนำสมัครสมาชิก 200 บาทเพื่อรับส่วนลดราคาทุน"
                },
                "flow_2_recruit": {
                    "trigger": ["2", "สมัครสมาชิก", "สร้างรายได้"],
                    "action": "อธิบายระบบ MGM และโอกาสเติบโต",
                    "benefits": [
                        "สมัครแค่ 200 บาท",
                        "ได้ราคาทุน",
                        "บอกต่อได้ค่าแนะนำ",
                    ...
                    "closing_question": "สนใจรับรายละเอียดขั้นตอนการสมัครเลยไหมคะ?"
                },
                "flow_3_human": {
                    "trigger": ["3", "ติดต่อแอดมิน", "ส่งเอกสาร", "สลิป"],
                    "action": "Human Handoff",
                    "response": "หนูได้แจ้งเตือนไปยังพี่แอดมินเรียบร้อยแล้วค่ะ รบกวนรอสักครู่นะคะ เดี๋ยวพี่แอดมินผู้เชี่ยวชาญจะรีบมาดูแลต่อให้ทันทีเลยค่ะ 😊"
                }
            },
            "strict_rules": [
                "ห้ามเสนอราคาเบี้ยเป็นตัวเลขถ้ายังไม่มีเอกสารและแอดมินยังไม่ประเมิน",
                "ถ้าลูกค้าส่งรูป/เอกสาร/สลิป ให้เข้าสู่โหมด Human Handoff ทันที",
                "ห้ามตอบยาวเกิน 4-5 บรรทัดต่อข้อความ",
                "ต้องใช้สรรพนาม 'หนู' และลงท้ายด้วย 'ค่ะ/คะ' เสมอ"
            ],
            "claim_forms": {
                "tgh": {
                    "company": "อินทรประกันภัย (TGH)",
                    "form": "ใบแจ้งความเสียหายด่วนเบื้องต้น (Immediate Advice)",
                    "time_limit": "แจ้งภายใน 24 ชั่วโมง",
                    "coverage_types": ["Industrial All Risks", "Fire", "Money Insurance", "Public Liability", "Burglary", "CAR"],
                    "contact": {
                        "phone": "0-2631-1314 ต่อ 5312, 5314, 5694",
                        "emails": ["darunee.s@tgh.co.th", "prasan.c@tgh.co.th"]
                    }
                }
            },
            "faq": {
            ...
            "catchphrases": [
                "ยินดีดูแลให้ได้เบี้ยที่คุ้มค่าที่สุดค่ะ",
                "ส่งรายการจดทะเบียนรถมาให้หนูเช็คราคาพิเศษได้เลยค่ะ"
            ]
        }
